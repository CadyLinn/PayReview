...
| --- | --- | --- | --- |
| Cady | PM、產品與 iOS 整合 | 產品規格、上線規劃、Onboarding、登入體驗、技術方向與跨功能整合 | 定義任務與驗收條件、維護 repository 規則與 Skill、核准產品及發布決策 |
| machshyi | UI/UX 與日常體驗 | Figma 對齊、Today、Plan、Records、財務互動與產品文件 | 提供畫面行為與互動基準、檢視 Agent UI 實作、驗證使用者流程與無障礙 |
| eli_liao | Firebase、驗證與資料安全 | Authentication、Firestore、Security Rules、帳號狀態、後端流程與資料模型 | 檢視 Agent 產生的雲端與安全變更、驗證權限、同步、失敗處理與敏感資料界線 |
